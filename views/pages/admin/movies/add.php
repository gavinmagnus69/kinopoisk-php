 ...
 <main>
    ...
    <div class="container d-flex justify-content-center">
        ...
        <form action="/admen/movies/add" method="post" class="d-flex flex-column justify-content-center w-50 gap-2 mt-5 mb-5">
            <div class="row g-2">
                <div class="col-md">
                    <div class="form-floating">
                        <input type="text" class="form-control <?php echo $session->has('name') ? 'is-invalid' : ''; ?>" id="name" name="name" placeholder="Название фильма">
