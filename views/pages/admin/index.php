 ...
 <main>
    <div class="container">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h4>Фильмы</h4>
            <a href="/admen/movies/add" class="btn btn-primary d-flex align-items-center gap-2">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h4>Жанры</h4>
            <a href="/admen/categories/add" class="btn btn-primary d-flex align-items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                </svg>
                <span>Добавить</span>
        ...
        <table class="table table-dark table-hover">
            ...
            <?php foreach ($categories as $category) {?>
               <?php $view->component('admin/category', ['category' => $category])?>
            <?php }?>
